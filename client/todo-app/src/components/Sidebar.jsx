  ...
  return (
    <div className="h-full min-h-screen w-64 bg-gradient-to-r from-[#FD6A5E] to-[#FF8A7A] flex flex-col rounded-r-md p-6 shadow-xl pt-24">
      ...
      <div className="mt-auto pt-8">
        <div className="flex items-center gap-2 px-4 py-3 mb-7 rounded-lg bg-white/20 text-white hover:bg-white/30 cursor-pointer font-semibold" onClick={logoutFunc}>
